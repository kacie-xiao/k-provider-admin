...
const setBacktopClass = computed(() => {
  ...
  return `.layout-backtop .el-scrollbar__wrap`;
});
...
onMounted(() => {
  ...
  $mittBus.on('onBacktop', () => {
    const dom = document.querySelector(setBacktopClass.value);
    if (dom) {

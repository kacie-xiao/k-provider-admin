<template>
  <div v-if="isShowBreadcrumb" class="layout-navbars-breadcrumb">
    <div
      class="layout-navbars-breadcrumb-icon flex justify-center items-center"
    >
      <n-icon size="1.5rem" @click="onThemeConfigChange">
        <MenuUnfoldOutlined v-if="themeConfig.isCollapse"></MenuUnfoldOutlined>
        <MenuFoldOutlined v-else></MenuFoldOutlined>
      </n-icon>
    </div>
    <n-breadcrumb class="layout-navbars-breadcrumb-hide">

!(function (e) {
      ...
      var e =
        ...
        (function (e, t) {
          ...
          const f = (o.BufferedBlockAlgorithm = i.extend({
            ...
            _append(e) {
              typeof e === 'string' && (e = l.parse(e)), this._data.concat(e), (this._nDataBytes += e.sigBytes);
            },
            _process(t) {
              const n = this._data;
              const r = n.words;
      ...
      return (
        o(e, null, [
          ...
          },
          {
            key: 'extend',
            value(e, t) {
              for (const n in t) Object.prototype.hasOwnProperty.call(t, n) && t[n] && (e[n] = t[n]);
            },
          },
          {
            key: 'isArray',
          ...
          },
          {
            ...
            value(e) {
              ...
              return `${e.getUTCFullYear()}-${t(e.getUTCMonth() + 1)}-${t(e.getUTCDate())}T${t(e.getUTCHours())}:${t(
                e.getUTCMinutes(),
              )}:${t(e.getUTCSeconds())}Z`;
            },
          },
  ...
  function (e, t, n) {
    ...
    const p = (function () {
      function e(t) {
        o(this, e);
        const n = h.default.os.name;
        const r = h.default.os.version || '';
        const i = h.default.browser.name;
        const a = h.default.browser.version || '';
            ...
            value(e, t) {
              ...
              if (((t = t || r.length), e)) for (n = 0; n < e; n++) o[n] = r[0 | (Math.random() * t)];
                ...
                for (o[8] = o[13] = o[18] = o[23] = '-', o[14] = '4', n = 0; n < 36; n++)
                  o[n] || ((i = 0 | (16 * Math.random())), (o[n] = r[n == 19 ? (3 & i) | 8 : i]));
              }
              return o.join('');
            },
          },
  ...
  function (e, t, n) {
    ...
    const i = function (e) {
      ...
      const r = navigator.platform == 'Win32' || navigator.platform == 'Windows' || t.indexOf('Windows') > -1;
      const o =
    ...
    const u = (function () {
      ...
      const d = !l && n.match(/(iPhone\sOS)\s([\d_]+)/);
      const h = n.match(/(webOS|hpwOS)[\s\/]([\d.]+)/);
      const p = /Win\d{2}|Windows/.test(r);
      const g = n.match(/Windows Phone ([\d.]+)/);
      const v = h && n.match(/TouchPad/);
      const y = n.match(/Kindle\/([\d.]+)/);
      const _ = n.match(/Silk\/([\d._]+)/);
      const m = n.match(/(BlackBerry).*Version\/([\d.]+)/);
      const w = n.match(/(BB10).*Version\/([\d.]+)/);
      const T = n.match(/(RIM\sTablet\sOS)\s([\d.]+)/);
      const S = n.match(/PlayBook/);
      const A = n.match(/Chrome\/([\d.]+)/) || n.match(/CriOS\/([\d.]+)/);
      const b = n.match(/Firefox\/([\d.]+)/);
      const I = n.match(/\((?:Mobile|Tablet); rv:([\d.]+)\).*Firefox\/[\d.]+/);
      const E = n.match(/MSIE\s([\d.]+)/) || n.match(/Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/);
      const k = !A && n.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/);
      const U = k || n.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/);
      if (
            ...
            value(e, t, n, r, o) {
              ...
              (n = n || function () {}),
                ...
                (i.onreadystatechange = function () {
                  i.readyState === 4 && (i.status === 200 ? t(i.responseText) : n(i.responseText));
                });
              try {
            ...
            value(e, t, n, r, o, i) {
              ...
              (n = n || function () {}),
                ...
                (a.onreadystatechange = function () {
                  a.readyState === 4 && (a.status === 200 ? t(a.responseText) : n(a.responseText));
                });
              try {
    ...
    (r = []),
      ...
      FileReader.prototype.readAsBinaryString ||
        (FileReader.prototype.readAsBinaryString = function (e) {
          ...
          (r.onload = function (e) {
            for (let o = new Uint8Array(r.result), i = o.byteLength, a = 0; a < i; a++) t += String.fromCharCode(o[a]);
          ...
          i(e, [
            ...
            },
            {
              ...
              value(e) {
                ...
                if ((this._initState(), (this._curIndex = this._findUploadIndex()), this._curIndex == -1))
            ...
            },
            {
              ...
              value() {
                ...
                if (this._state == a.VODSTATE.START)
                  if (((this._curIndex = this._findUploadIndex()), this._curIndex != -1)) {
            ...
            },
            {
              ...
              value() {
                if (
                  (this._state == a.VODSTATE.START || this._state == a.VODSTATE.FAILURE || this._curIndex == -1) &&
                  this._curIndex != -1
                ) {
              ...
              value(e, t) {
                if (t.name == 'cancel')
                  ...
                  if (
                    ...
                    t.name == 'SignatureDoesNotMatchError' ||
                    t.code == 'SecurityTokenExpired' ||
                    t.code == 'InvalidSecurityToken.Expired' ||
                    (t.code == 'InvalidAccessKeyId' && this._ossCreditor.securityToken)
                  ) {
                  ...
                  t.name == 'NoSuchUploadError'
                    ...
                    : t.name == 'abort' &&
                      (this._removeCheckoutpoint(e),
                      this.options.onUploadFailed(e, 'OSSAbort', '由于 OSS Abort 上传中止')),
            ...
            },
            {
              ...
              value(e, t, n) {
                ...
                if (
                  ...
                  t.loaded != 0 && this._reportLog('20007', e, { pn: i, requestId: s }),
                  t.loaded != 1 &&
                  ...
                  try {
                    ...
                    A.default.upload(
                      ...
                      function () {},
                      function (e) {
                        if ((e = JSON.parse(e)) && e.Code == 'InvalidParameter' && e.Message.indexOf('UserId') > 0) {
                          c._invalidUserId = !0;
                          const t = `${e.Message}，正确账号ID(userId)请参考：https://help.aliyun.com/knowledge_detail/37196.html`;
                          console.log(t);
                        }
              ...
              value() {
                ...
                window &&
                  (window.onbeforeunload = function (t) {
                    if (((e._onbeforeunload = !0), e._curIndex != -1 && e._uploadList.length > e._curIndex)) {
  ...
  function (e, t, n) {
    (function (e) {
      ...
      function u(e, t, n, r) {
        return (
          s(t),
          t <= 0 ? o(e, t) : void 0 !== n ? (typeof r === 'string' ? o(e, t).fill(n, r) : o(e, t).fill(n)) : o(e, t)
        );
      }
      function c(e, t) {
        if ((s(t), (e = o(e, t < 0 ? 0 : 0 | p(t))), !i.TYPED_ARRAY_SUPPORT)) for (let n = 0; n < t; ++n) e[n] = 0;
        return e;
      }
      function l(e, t, n) {
        if (((typeof n === 'string' && n !== '') || (n = 'utf8'), !i.isEncoding(n)))
      ...
      function h(e, t) {
        ...
        if (t) {
          if ((typeof ArrayBuffer !== 'undefined' && t.buffer instanceof ArrayBuffer) || 'length' in t)
            return typeof t.length !== 'number' || J(t.length) ? o(e, 0) : f(e, t);
      ...
      function m(e, t, n, r, o) {
        ...
        if ((typeof t === 'string' && (t = i.from(t, r)), i.isBuffer(t))) return t.length === 0 ? -1 : w(e, t, n, r, o);
        if (typeof t === 'number')
          return (
            (t &= 255),
            i.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf === 'function'
              ? o
      ...
      function k(e, t, n) {
        return t === 0 && n === e.length ? G.fromByteArray(e) : G.fromByteArray(e.slice(t, n));
      }
      function U(e, t, n) {
          ...
          if (o + s <= n) {
            ...
            switch (s) {
              case 1:
                ...
                break;
              case 2:
                (u = e[o + 1]), (192 & u) == 128 && (f = ((31 & i) << 6) | (63 & u)) > 127 && (a = f);
                break;
              case 3:
                (u = e[o + 1]),
                  (c = e[o + 2]),
      ...
      function B(e, t, n, r) {
        ...
        for (let o = 0, i = Math.min(e.length - n, 4); o < i; ++o) e[n + o] = (t >>> (8 * (r ? o : 3 - o))) & 255;
      }
      ...
      (t.Buffer = i),
        ...
        (i.prototype.toString = function () {
          ...
          return e === 0 ? '' : arguments.length === 0 ? U(this, 0, e) : y.apply(this, arguments);
        }),
      ...
      (i.prototype.slice = function (e, t) {
        ...
        (i.prototype.readIntLE = function (e, t, n) {
          (e |= 0), (t |= 0), n || D(e, t, this.length);
          for (var r = this[e], o = 1, i = 0; ++i < t && (o *= 256); ) r += this[e + i] * o;
          return (o *= 128), r >= o && (r -= 2 ** (8 * t)), r;
        }),
        (i.prototype.readIntBE = function (e, t, n) {
          (e |= 0), (t |= 0), n || D(e, t, this.length);
          for (var r = t, o = 1, i = this[e + --r]; r > 0 && (o *= 256); ) i += this[e + --r] * o;
          return (o *= 128), i >= o && (i -= 2 ** (8 * t)), i;
        }),
        ...
        (i.prototype.writeIntLE = function (e, t, n, r) {
          ...
          for (this[t] = 255 & e; ++i < n && (a *= 256); )
            e < 0 && s === 0 && this[t + i - 1] !== 0 && (s = 1), (this[t + i] = (((e / a) >> 0) - s) & 255);
          return t + n;
        }),
        ...
        (i.prototype.fill = function (e, t, n, r) {
          if (typeof e === 'string') {
            ...
            if (typeof r === 'string' && !i.isEncoding(r)) throw new TypeError(`Unknown encoding: ${r}`);
          ...
          if (typeof e === 'number') for (a = t; a < n; ++a) this[a] = e;
            ...
            const s = i.isBuffer(e) ? e : V(new i(e, r).toString());
            const u = s.length;
    ...
    function a(e) {
      ...
      for (n = 0; n < l; n += 4)
        (t =
          ...
          (u[c++] = 255 & t);
      return (
        s === 2 && ((t = (f[e.charCodeAt(n)] << 2) | (f[e.charCodeAt(n + 1)] >> 4)), (u[c++] = 255 & t)),
        s === 1 &&
        ...
        i(e, null, [
          {
            ...
            value(e, t, n) {
              ...
              const i = `${c.default.makeUTF8sort(o, '=', '&')}&Signature=${c.default.aliyunEncodeURI(
          ...
          function t(e, t, n) {
            for (var r = [], i = 0, a = 0; a < t; a++)
              if (a % 4) {
                ...
                const u = n[e.charCodeAt(a)] >>> (6 - (a % 4) * 2);
        ...
        i(e, null, [
          ...
          },
          {
            ...
            value(t, n, r) {
              ...
              a && (d.ClientId = a);
              const p = `${y.default.makeUTF8sort(d, '=', '&')}&Signature=${y.default.aliyunEncodeURI(
                y.default.makeChangeSiga(d, t.accessKeySecret),
              )}`;
              const v = `https://vod.${t.region}.aliyuncs.com/?`;
              s.default.post(
                v,
                function (e) {
                  n && n();
          ...
          o(e, null, [
            {
              ...
              value(e, t, n) {
                ...
                (r.onload = function (e) {
                  try {
                    const n = (e && e.target.result) || r.content;
                    const o = i(a.parse(n));
                    const s = o.toString();
                    const u = window.btoa(o.toString(a));
                    t(s, u);
                  } catch (e) {
                    console.log(e);
                  }
                ...
                const o = File.prototype.slice || File.prototype.mozSlice || File.prototype.webkitSlice;

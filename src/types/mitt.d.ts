 ...
 * @method onRefreshCurrentTagsView tagsview 页面刷新
 */
declare type MittType<T = any> = {
  ...
  onRefreshCurrentTagsView: import("vue-router").RouteLocationNormalizedLoaded;
  onOpenMaterialSelect: T;
  onMaterialSelectEnd: T;
  onInstallEnd: T;
};
